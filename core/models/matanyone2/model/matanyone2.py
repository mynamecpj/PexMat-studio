...
from core.models.matanyone2.model.big_modules import PixelEncoder, UncertPred, KeyProjection, MaskEncoder, PixelFeatureFuser, MaskDecoder
from core.models.matanyone2.model.aux_modules import AuxComputer
from core.models.matanyone2.model.utils.memory_utils import get_affinity, readout
from core.models.matanyone2.model.transformer.object_transformer import QueryTransformer
from core.models.matanyone2.model.transformer.object_summarizer import ObjectSummarizer
from core.models.matanyone2.utils.tensor_utils import aggregate
from core.models.matanyone2.utils.device import get_default_device, safe_autocast
...
class MatAnyone2(nn.Module,
    ...
    def encode_image(self, image: torch.Tensor, seq_length=None, last_feats=None) -> (
    Iterable[torch.Tensor], torch.Tensor):  # type: ignore

        curr_mean = self.pixel_mean.to(image.device)
        curr_std = self.pixel_std.to(image.device)


        image = (image - curr_mean) / curr_std
